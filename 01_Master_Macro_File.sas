...
/* 
NOTE- I made 2 changes:

1) Instead of pulling from local copy of aa.auditfees, I pull from aa.fees_dup
This is a the download of the audit analytics auditfees file before duplicates are filtered out

2) I altered the end of the code so that company_fkey is included in output of dataset

These changes are labeled as:
...
proc sql;
    ...
    select a.*, b.name
    from
        aa.Auditfees_09212016 /*CHANGE FROM ORIGINAL CODE*/ a
    LEFT JOIN
        aa.Namesauditfees b
    on
